  ...
  .then((data) => {
    ...
    <div class="border-[#26A5D2] border-r py-1">
      <input
        name="Jamaa'ah"
        type="text"
        value="${calculateJamaaahTime(date.timings.Fajr, jamaaahOffsetMinutes)}"
    ...
    <div class="border-[#26A5D2] border-r py-1">
      <input
        name="Jumu'Asr"
        type="text"
        value="${calculateJamaaahTime(date.timings.Asr, jamaaahOffsetMinutes)}"
    ...
    <div class="border-[#26A5D2] py-1">
      <input
        name="Ishaa"
        type="text"
        value="${calculateJamaaahTime(date.timings.Isha, jamaaahOffsetMinutes)}"
